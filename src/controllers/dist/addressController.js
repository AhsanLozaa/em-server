...
exports.saveUserAddress = exports.getUserAddress = void 0;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    userId = req.userId;
                    return [4 /*yield*/, addressService_1.findAddressByUserId(userId)];
                case 1:
                    address = _a.sent();
                    res.status(200).json({
                        address: address
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, addressService_1.saveAddress(req.body)];
                case 1:
                    address = _a.sent();
                    res.status(200).json({
                        address: address
