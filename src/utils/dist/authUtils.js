...
exports.decodeRefreshToken = exports.decodeAccessToken = exports.verifyRefreshToken = exports.simp = exports.simplyVerifyAccessToken = exports.verifyAccessToken = exports.generateTokens = exports.updateTokens = exports.createAndUpdateTokens = exports.generateRefreshToken = exports.generateAccessToken = void 0;
...
exports.simplyVerifyAccessToken = function (accessToken) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, true];
    });
}); };
function simp(accessToken) {
    return new Promise(function (resolve, reject) {
        jsonwebtoken_1["default"].verify(accessToken, ACCESS_TOKEN_SECRET, function (error, decoded) {
            if (error) {
                reject(new Error('Invalid access token'));
